                        ...
                        <div class="widget">
                            ...
                            @endphp
                                ...
                                @foreach($category as $value)
                                    <li><a href="{{url('techblog/category/'.$value->id)}}">{{$value->catName}} <span>@if($value->post > 0 && $value->post <= 9)(0{{$value->post}})@elseif($value->post == 0)({{$value->post}}) @elseif($value->post > 9) ({{$value->post}}) @endif</span></a></li>
                                @endforeach
                                </ul>
                            </div><!-- end link-widget -->
                        </div><!-- end widget -->
